...
module.exports = {
    ...
    execute(message, args) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor(0x00FF00) // Borde izquierdo en color verde
            .setDescription(
            ...
            .setImage('https://cdn.discordapp.com/attachments/1480431171069284352/1512654936310284288/Picsart_26-06-06_00-08-11-550.jpg?ex=6a24e130&is=6a238fb0&hm=a6a12d9875cdc8e8382c88fd6b9dbcda0722ad6cab37d2ba1fd22e3778001aec&') // Reemplazá esto por la URL de tu imagen
        ...
        const row = new ActionRowBuilder().addComponents(
            new ButtonBuilder()
                ...
                .setEmoji('<:emoji_58:1512619522161508432>') // Tu emoji personalizado integrado
        );
